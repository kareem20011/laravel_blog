<div class="sidebar">
        <nav class="sidebar-nav">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('dashboard.setting')}}"><i class="fa fa-cog" aria-hidden="true"></i> Settings</a>
                </li>
                ...
                <li class="nav-item">
                    <form method="post" action="{{route('logout')}}" >
                        @csrf
                        <button class="nav-link" href="{{route('logout')}}" type="submit"><i class="fa fa-sign-out"></i> {{__('words.logout')}}</button>
                    </form>
                </li>
